...
```{r}
# plot ROC curves 
plot(ROC_rf2, col = "red", legacy.axes = TRUE, main = "ROC For Random Forest, Default Settings")
lines(ROC_rf, col = "green", legacy.axes = TRUE)
# print the performance of each model 
paste("Accuracy % of default random forest: ", mean(heart_test$DEATH_EVENT == round(prediction[,2], digits = 0)))
paste("Area under curve of default random forest: ", ROC_rf_auc)
...
The accuracy and area under the receiver operating characteristic curve (AUC-ROC) is higher for the model produced using the tuned mtry (88.3%) compared to the default model (81.7%). The AUC-ROC for the tuned model is slightly lower than that of the default model (0.844 and 0.858, respectively).
