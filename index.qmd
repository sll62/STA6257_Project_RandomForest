...
An important feature of random Forest is its ability to provide a measure of how strong a given variable is associated with a classification result.  These four measures include raw importance score for class 0, raw importance score for class 1, decrease in accuracy, and the Gini Index [@esmaily2018comparison].  Gini Index is explained later.  These scores help users fine-tune the Random Forest method so optimal classification results are achieved.
