...
There are a number of metrics available for assessing a classification model's performance. The one's utilized here (00B error rate/accuracy, precision, recall, F1 score, balanced accuracy, and AUC-ROC) are described in the following text:
