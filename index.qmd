...
## Below is new analysis conducted after the in-class presentation
...
#  I Think I generated the Gini Coefficient for Age.
#  Do you think this ic correct?
#  Is there a better way to do this for all of the variables?

```

```{r}
#  Below we are creating datasets based on Gini Coefficients.  We begin with all variables
# and then remove the variable with the lowest Gini Coefficient as we craete new datasets

# heart_df_noBinary contains all the variables 
...
# heart_df_noBinary_noSerum_sodium contains the following variables
# creatinine_phosphokinase	
# time	                   
# serum_creatinine	        
# platelets	              
...
## Below is Random Forest performance for heart_df_noBinary
...
set.seed(123)
samp <- sample(nrow(heart_df_noBinary), 0.8 * nrow(heart_df_noBinary))

heart_train <- heart_df_noBinary[samp, ]
heart_test <- heart_df_noBinary[-samp, ]
...
## Below is Random Forest performance for heart_df_noBinary_noSerum_sodium

```{r}
# Below is Random Forest performance for heart_df_noSerum_sodium

# split the data, 80% goes to training and 20% goes to testing

set.seed(123)
samp <- sample(nrow(heart_df_noBinary_noSerum_sodium), 0.8 * nrow(heart_df_noBinary_noSerum_sodium))

heart_train <- heart_df_noBinary_noSerum_sodium[samp, ]
heart_test <- heart_df_noBinary_noSerum_sodium[-samp, ]
...
## Below is Random Forest performance for heart_df_noBinary_noAge

```{r}
# Below is Random Forest performance for heart_df_noAge

# split the data, 80% goes to training and 20% goes to testing

set.seed(123)
samp <- sample(nrow(heart_df_noBinary_noAge), 0.8 * nrow(heart_df_noBinary_noAge))

heart_train <- heart_df_noBinary_noAge[samp, ]
heart_test <- heart_df_noBinary_noAge[-samp, ]
...
## Below is Random Forest performance for heart_df_noBinary_noEjection_fraction

```{r}
# Below is Random Forest performance for heart_df_noEjection_fraction

# split the data, 80% goes to training and 20% goes to testing

set.seed(123)
samp <- sample(nrow(heart_df_noBinary_noEjection_fraction), 0.8 * nrow(heart_df_noBinary_noEjection_fraction))

heart_train <- heart_df_noBinary_noEjection_fraction[samp, ]
heart_test <- heart_df_noBinary_noEjection_fraction[-samp, ]
...
## Below is Random Forest performance for heart_df_noBianry_noPlatelets

```{r}
# Below is Random Forest performance for heart_df_noPlatelets

# split the data, 80% goes to training and 20% goes to testing

set.seed(123)
samp <- sample(nrow(heart_df_noBinary_noPlatelets), 0.8 * nrow(heart_df_noBinary_noPlatelets))

heart_train <- heart_df_noBinary_noPlatelets[samp, ]
heart_test <- heart_df_noBinary_noPlatelets[-samp, ]
...
## Below is Random Forest performance for heart_df_noBinary_noSerum_creatinine

```{r}
# Below is Random Forest performance for heart_df_noSerum_creatinine

# split the data, 80% goes to training and 20% goes to testing

set.seed(123)
samp <- sample(nrow(heart_df_noBinary_noSerum_creatinine), 0.8 * nrow(heart_df_noBinary_noSerum_creatinine))

heart_train <- heart_df_noBinary_noSerum_creatinine[samp, ]
heart_test <- heart_df_noBinary_noSerum_creatinine[-samp, ]
...
## Below is Random Forest performance for heart_df_noBinary_noTime
...
set.seed(123)
samp <- sample(nrow(heart_df_noBinary_noTime), 0.8 * nrow(heart_df_noBinary_noTime))

heart_train <- heart_df_noBinary_noTime[samp, ]
heart_test <- heart_df_noBinary_noTime[-samp, ]
...
## Below I am starting over with the datasets created in the opposite order.

```{r}
# It seems I did the above backwards.  I should have removed those variables with the largest Gini index.
# See https://www.cloudzilla.ai/dev-education/hyperparmeter-tuning/

# Below is the dataset with no binary variables and creatinine_phosphokinase removed 
heart_df_noCreatinine_phosphokinase = select(heart_df, time, serum_creatinine, platelets, ejection_fraction, age, serum_sodium, DEATH_EVENT)
...
# serum_sodium
# DEATH_EVENT
heart_df_noCreatinine_phosphokinase = select(heart_df, age, ejection_fraction, platelets, serum_creatinine, serum_sodium, time, DEATH_EVENT)

# Below is the dataset with no binary variables and time removed 
# serum_creatinine	        
# platelets	              
# ejection_fraction	       
# Age	                      
# serum_sodium
# DEATH_EVENT
heart_df_noTime = select(heart_df, age, ejection_fraction, platelets, serum_creatinine, serum_sodium, DEATH_EVENT)

# Below is the dataset with no binary variables and serum_creatinine removed 
# platelets	              
# ejection_fraction	       
# Age	                      
# serum_sodium
# DEATH_EVENT
heart_df_noSerum_creatinine = select(heart_df, age, ejection_fraction, platelets, serum_sodium, DEATH_EVENT)

# Below is the dataset with no binary variables and platelets removed 
# ejection_fraction	       
# Age	                      
# serum_sodium
# DEATH_EVENT
heart_df_noPlatelets = select(heart_df, age, ejection_fraction, serum_sodium, DEATH_EVENT)

# Below is the dataset with no binary variables and ejection_fraction removed 
# Age	                      
# serum_sodium
# DEATH_EVENT
heart_df_noEjection_fraction = select(heart_df, age, serum_sodium, DEATH_EVENT)

# Below is the dataset with no binary variables and age removed 
# serum_sodium
# DEATH_EVENT
heart_df_noAge = select(heart_df, serum_sodium, DEATH_EVENT)
```

## Below is Random Forest performance for heart_df_noCreatinine_phosphokinase
...
set.seed(123)
samp <- sample(nrow(heart_df_noCreatinine_phosphokinase), 0.8 * nrow(heart_df_noCreatinine_phosphokinase))

heart_train <- heart_df_noCreatinine_phosphokinase[samp, ]
heart_test <- heart_df_noCreatinine_phosphokinase[-samp, ]
...
## Below is Random Forest performance for heart_df_noTime
...
set.seed(123)
samp <- sample(nrow(heart_df_noTime), 0.8 * nrow(heart_df_noTime))

heart_train <- heart_df_noTime[samp, ]
heart_test <- heart_df_noTime[-samp, ]
...
set.seed(123)
samp <- sample(nrow(heart_df_noSerum_creatinine), 0.8 * nrow(heart_df_noSerum_creatinine))

heart_train <- heart_df_noSerum_creatinine[samp, ]
heart_test <- heart_df_noSerum_creatinine[-samp, ]
...
set.seed(123)
samp <- sample(nrow(heart_df_noPlatelets), 0.8 * nrow(heart_df_noPlatelets))

heart_train <- heart_df_noPlatelets[samp, ]
heart_test <- heart_df_noPlatelets[-samp, ]
...
set.seed(123)
samp <- sample(nrow(heart_df_noEjection_fraction), 0.8 * nrow(heart_df_noEjection_fraction))

heart_train <- heart_df_noEjection_fraction[samp, ]
heart_test <- heart_df_noEjection_fraction[-samp, ]
...
set.seed(123)
samp <- sample(nrow(heart_df_noAge), 0.8 * nrow(heart_df_noAge))

heart_train <- heart_df_noAge[samp, ]
heart_test <- heart_df_noAge[-samp, ]
...
<table class="tb" title="Datasets Removal of Variables with Largest Gini Index">
  ...
  <tr>
    <td>Creatine_Phosphokinase (CP)</td>
    <td>0.6082741</td>
    <td>SS, A, EF, P, SC, T, and CP</td> 
    <td>80.00 %</td>
  </tr>
  <tr>
    <td>Time (T)</td>
    <td>.03416812</td>
     <td>SS, A, EF, P, SC, and T</td> 
    <td>80.00 %</td>
  </tr>
  <tr>
    <td>Serum_Creatinine (SC)</td>
    <td>0.2799149</td>
    <td>SS, A, EF, P, and SC</td> 
    <td>71.67 %</td>
  </tr>
  <tr>
    <td>Platelets (P)</td>
...
## Team, above are the results I get, but I do not know if I did the analysis the correct way.

## From my results, it seems the highest accuracy is 80%, and this happens when we use all of the variables in the model, and also when we use all but creatinine_phosphokinase.
