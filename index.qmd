...
## Introduction
Understanding the causes and risk factors of heart failure is obscured by contributing factors such as coronary artery disease, hypertension, obesity, infection, certain medications, and lifestyle choices such as alcohol consumption, smoking, and drug abuse.  Machine Learning is one of the tools used by Health Care Professionals to disentangle the contending factors and make sense of the contributing influences.  Unsupervised Machine Learning is a branch of artificial intelligence that attempts to discover patterns and insights without explicit human guidance or instruction.  A promising machine learning model is the Random Forest.  In this report we validate the application of Random Forest machine learning to support the accurate prediction of heart failure.  
