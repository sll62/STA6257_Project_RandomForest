...
The features of the Heart Failure Clinical Records dataset are described in the following table:
...
| ----------------------:| :-------------------------------------------------------- |
| Age                    | Age of patient                                            |
| Anemia                 | Decrease of red blood cell or hemoglobin                  |
| Creatine Phosphokinase | Level of CPK enzyme in the blood                          |
| Diabetes               | If the patient has diabetes                               |
| Ejection Fraction      | Percentage of blood leaving the heart at each contraction |
| High Blood Pressure    | If the patient has hypertension                           |
| Platelets              | Platelets in the blood                                    |
| Serum Creatinine       | Level of  serum creatine in the blood                     |
