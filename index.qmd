...
We fit the dataset by removing all binary variables.  The removed variables include the following;
...
We calculate the <em>Gini Index</em> for each of the remaining variables and display them in the table that follows.
...
We create multiple permutations of the model, and with each permutation we remove the variable with the lowest Gini Index.  We display the results in the table that follows.
