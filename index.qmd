...
cf <- confusionMatrix(prediction, heart_test$DEATH_EVENT, mode = "everything")
cf
```
...
hm <- readr::read_delim("y True False
True 4 36
False 17 3", delim = " ")

hm <- hm %>% gather(x, value, True:False)
...
cf2 <- confusionMatrix(prediction2, heart_test$DEATH_EVENT, mode = "everything")
cf2
```
...
cf3 <- confusionMatrix(prediction3, heart_test$DEATH_EVENT, mode = "everything")
cf3
```
